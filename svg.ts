...
namespace MSvg {
	 ...
	 */
	function drawMeasure(input: object[], scale: number, width: number,
		initXpos: number, ypos: number) : string {		
		var out = "";
	 ...
	 */
	function drawSystem(measures: object[][], scale: number, width: number, ypos: number) : string {
		var out = "";
	 ...
	 */
	export function convert(input: object[], scale: number, width: number) : string {
		var out = "";

		var measures: object[][] = []; // measures of system
		var measure: object[] = [];
